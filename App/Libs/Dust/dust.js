...
var Dust = (function () {
  ...
  _createClass(Dust, [{
    ...
    value: function create() {
      ...
      var isAlphaChangeEnabled = arguments[19] === undefined ? false : arguments[19];// Gal 2019.10.12.
      ...
      var makeParticle = function makeParticle(angle) {
        ...
        particle.updateParticle = function () {
          ...
          // Gal 2019.10.12.
          if (isAlphaChangeEnabled)
            particle.alpha -= particle.alphaSpeed;
          particle.alpha1 -= particle.alphaSpeed;


          //Remove the particle if its `alpha` reaches zero
          if (particle.alpha1 <= 0) {// Gal 2019.10.12.
