...
var Loader = {
	...
	showLoadProgress: function() {
		...
		$("button#home").css({"z-index": "10000", "opacity": "0.5"});
		$("button#menu").css({"z-index": "9999", "opacity": "0.0"});
		$("button#sound").css({"z-index": "10000", "opacity": "0.5"});
		$("button#sound").attr("disabled", "true");
